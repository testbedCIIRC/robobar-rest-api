...
class RobobarOpcClient(Client):
    ...
    def _init_nodes(self):
        ...
        self._push_new_order_node = self.get_node('ns=3;s="Web_Terminal_Communication"."Terminal_Output"."pushNewOrderToQueue"')
        self._new_order_use_ice_node = self.get_node('ns=3;s="Web_Terminal_Communication"."Terminal_Output"."newOrderUseIce"')
        self._new_order_drink_size_node = self.get_node('ns=3;s="Web_Terminal_Communication"."Terminal_Output"."newOrderDrinkSizeId"')
        self._new_drink_type_id_node = self.get_node('ns=3;s="Web_Terminal_Communication"."Terminal_Output"."newOrderDrinkTypeId"')
        self._order_pushed_successfully_node = self.get_node('ns=3;s="Web_Terminal_Communication"."Terminal_Input"."orderPushedSuccessfully"')
        self._success_order_number_node = self.get_node('ns=3;s="Web_Terminal_Communication"."Terminal_Input"."successOrderNumber"')
    ...
    def push_new_drink(self, drink_type_id, new_order_use_ice=False, drink_size=1):
        ...
        while (datetime.now() - start_time).total_seconds() < 5:
            if self._push_new_order_node.get_value() == False:
    ...
    def get_new_order_status(self):
        return {
            "newOrderStatus": {
                "orderPushedSuccessfully": self._order_pushed_successfully_node.get_value(),
                "pushedOrderNumber": self._success_order_number_node.get_value()
            }
        }
